...
do
    ...
    tracers_settings.enemycolor = Color3.fromRGB(255,255,255) -- 238,38,37, 255,0,13, 255,7,58
...
do
    ...
    esp_settings.enemycolor = Color3.fromRGB(255,255,255) -- 238,38,37, 255,0,13, 255,7,58
...
do
    ...
    boxes_settings.enemycolor = Color3.fromRGB(255,255,255) -- 238,38,37, 255,0,13, 255,7,58
    ...
    function visuals.step()
        ...
        if credits == nil then
            credits = newdrawing("Text", {
                Text = "AimHot Rush Point, Herrtt#3868 - motwrrt#2983"; -- yes now be happy this is free
